$(function () {
  ...
  $(".movie-button").on("click", function () {
    var my_api_key = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjODg0NmY5ODljMjRjNGE5ZjNlNDU2ZTk1OThmMTMzZSIsInN1YiI6IjY1NmQxNTNlODg2MzQ4MDE0ZDg0YjNkNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.azV8PdOqYLXBdHcwG8MXVGVFLTLw2FOfp90xj9jlLGE";
    var title = $(".movie").val();
    if (title == "") {
...
function load_details(my_api_key, title) {
  $.ajax({
    type: "GET",
    headers: {
     "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjODg0NmY5ODljMjRjNGE5ZjNlNDU2ZTk1OThmMTMzZSIsInN1YiI6IjY1NmQxNTNlODg2MzQ4MDE0ZDg0YjNkNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.azV8PdOqYLXBdHcwG8MXVGVFLTLw2FOfp90xj9jlLGE"
    },
    url:
